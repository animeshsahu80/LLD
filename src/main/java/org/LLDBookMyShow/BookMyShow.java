...
import org.LLDBookMyShow.Enums.SeatCategory;
...
public class BookMyShow {
    ...
    private void createBooking(City userCity, String movieName) {
        ...
        //5. select the seat
        int seatNumber = 30;
        List<Integer> bookedSeats = interestedShow.getNumOfSeatsBooked();
